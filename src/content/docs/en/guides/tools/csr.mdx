...
4. **Choose a signing algorithm**  
   - **RSA2048 / RSA3072 / RSA4096** — Maximizes compatibility at increasing security levels.  
   - **EC256 / EC384** — Recommended for modern workloads thanks to smaller keys and faster handshakes.
...
| --------- | ---------- | ------------------- | ----------- | ------------- |
| RSA2048   | 2048 bits  | Baseline            | ★★★☆☆       | ★★★★★         |
| RSA3072   | 3072 bits  | High                | ★★☆☆☆       | ★★★★★         |
| RSA4096   | 4096 bits  | Very high           | ★☆☆☆☆       | ★★★★★         |
| EC256     | 256 bits   | ≈ RSA3072           | ★★★★★       | ★★★★☆         |
| EC384     | 384 bits   | ≈ RSA7680           | ★★★★☆       | ★★★★☆         |

<Aside type="tip">
  EC256 offers the best balance of performance and security for most deployments.
</Aside>
